    ...
    <div class="container">
      <el-form :inline="true">
        ...
        <el-form-item label="标签" >
          <el-select multiple collapse-tags allow-create filterable v-model="blog.tags" placeholder="选择标签" clearable>
      ...
      <div class="desc">
        <el-input type="textarea" v-model="blog.desc" :rows="1" placeholder="请输入博客描述"></el-input>
      </div>
      <el-input v-model="blog.cover" class="cover" placeholder="请输入博客封面地址">
        <template slot="prepend">封面地址</template>
      </el-input>
      <div class="buttons">
        <el-button type="success" size="mini" plain @click="submit">提交</el-button>
